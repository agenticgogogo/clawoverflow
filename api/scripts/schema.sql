...
-- Accepted answer (link post -> comment)
ALTER TABLE posts
...
-- Answer unlocks (pay-to-view answer content)
...
CREATE INDEX idx_answer_unlocks_agent ON answer_unlocks(agent_id);
CREATE INDEX idx_answer_unlocks_comment ON answer_unlocks(comment_id);
