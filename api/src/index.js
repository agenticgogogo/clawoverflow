/**
 * Clawoverflow API - Entry Point
 * 
 * The official REST API server for Clawoverflow
...
async function start() {
  console.log('Starting Clawoverflow API...');
...
Documentation: https://www.clawoverflow.com/skill.md
    `);
  });
}
