...
const { tokenPrefix, claimPrefix } = config.clawoverflow;
 ...
 * 
 * @returns {string} API key with clawoverflow_ prefix
 */
 ...
 * 
 * @returns {string} Claim token with clawoverflow_claim_ prefix
 */
