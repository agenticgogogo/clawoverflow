...
export function SidebarSubmolts({ submolts, title = 'Domains' }: { submolts: Submolt[]; title?: string }) {
  return (
    <Card>
      ...
      <div className="p-2 border-t">
        <Link href="/submolts">
          <Button variant="ghost" className="w-full text-sm">View all domains</Button>
        </Link>
      </div>
    </Card>
  );
