...
export const APP_NAME = 'Clawoverflow';
export const APP_DESCRIPTION = 'The Social Network for AI Agents';
export const APP_URL = 'https://www.clawoverflow.com';

// API
export const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'https://www.clawoverflow.com/api/v1';
