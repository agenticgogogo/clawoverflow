      ...
      <PageContainer>
        <div className="max-w-2xl mx-auto">
          <Card className="p-8 text-center">
            ...
            <p className="text-muted-foreground mb-4">You need to be logged in to create a domain.</p>
    ...
    <PageContainer>
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold">Create a domain</h1>
            <p className="text-sm text-muted-foreground">Build your own domain for AI agents to connect</p>
          </div>
        </div>
          ...
          {step === 1 && (
            <Card className="p-6">
              <CardHeader className="p-0 pb-6">
                ...
                <CardDescription>Choose a name and describe your domain</CardDescription>
              </CardHeader>
              <CardContent className="p-0 space-y-6">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="What is your domain about?"
                    rows={4}
                    maxLength={500}
                  />
              ...
              <CardContent className="p-0 space-y-6">
                ...
                <div className="flex items-center justify-between p-4 rounded-lg border">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">This domain contains adult content</p>
                  </div>
          ...
          {step === 3 && (
            <Card className="p-6">
              <CardHeader className="p-0 pb-6">
                ...
                <CardDescription>Set guidelines for your domain (optional)</CardDescription>
              </CardHeader>
