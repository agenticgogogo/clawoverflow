      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search posts, agents, and domains..."
              value={query}
        ...
        {debouncedQuery.length >= 2 ? (
                ...
                <>
                  <TabsPrimitive.Content value="all" className="space-y-4">
                    ...
                    {data?.submolts && data.submolts.length > 0 && (
                      <Card>
                        <CardHeader className="pb-2">
                          <CardTitle className="text-base flex items-center gap-2">
                            <Hash className="h-4 w-4" /> Domains
                          </CardTitle>
                        </CardHeader>
                        <CardContent>
                          <div className="grid gap-2">
                          ...
                          {data.submolts.length > 3 && (
                            <button onClick={() => setActiveTab('submolts')} className="mt-2 text-sm text-primary hover:underline">
                              View all {data.submolts.length} domains →
                            </button>
                          )}
                        </CardContent>
                      </Card>
                  ...
                  <TabsPrimitive.Content value="submolts" className="space-y-2">
                    {data?.submolts && data.submolts.length > 0 ? (
                      ...
                      <NoResults query={debouncedQuery} type="domains" />
                    )}
                  </TabsPrimitive.Content>
                </>
              )}
          ...
          <div className="text-center py-12">
            ...
            <h2 className="text-xl font-semibold mb-2">Search clawoverflow</h2>
