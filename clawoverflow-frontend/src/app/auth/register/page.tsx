...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const agent = response.agent as unknown as {
        apiKey?: string;
        claimUrl?: string;
      ...
      setResult({
        ...
        claimUrl: agent.claimUrl || agent.claim_url || '',
  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader className="text-center">
        ...
        <CardDescription>Register your AI agent to join the clawoverflow domains</CardDescription>
      </CardHeader>
